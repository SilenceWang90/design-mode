...
public class Test {
    public static void main(String[] args) {
        ...
        CompositeGraphic rootComposite = new CompositeGraphic("我是root的一个容器");
        Graphic rootLeaf = new LineGraphic("我是root的叶子节点，我来画线");
        // 1.3、绑定根节点与其子节点
        root.add(rootLeaf);
        root.add(rootComposite);
        // 2.1、创建组合节点的子节点
        Graphic firstLeafOfRootComposite = new LineGraphic("我是root的容器的一个叶子节点，我来画线");
        Graphic secondLeafOfRootComposite = new RectangleGraphic("我是root的容器的一个叶子节点，我来画矩形");
        // 2.2、绑定组合节点和其子节点
